...
bind_bottom_up(MySQL_Command_Header, MySQL_COM_FIELD_LIST, Command=lambda x: x==COM_FIELD_LIST)
...
class MySQL_Result_Row_Data(Packet):
	...
	fields_desc = [
		FieldListField("ColumnValues",None,LengthCodedBinaryField("ColumnValue",b'')),
	]
